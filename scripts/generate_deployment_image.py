"""Generate a PNG preview of the deployed Emotion Detector app."""
...
OUTPUT = Path(__file__).resolve().parents[1] / "6b_deployment_test.png"
...
def main() -> None:
    """Render the deployment preview image."""
    ...
    draw.text(
        (395, 560),
        "I am excited about presenting this project.",
        fill=(88, 103, 122),
        font=_font(28),
    )
    ...
    result_box = (365, 775, 1075, 980)
    _rounded_box(draw, result_box, 20, (244, 248, 252))
    draw.text((395, 805), "Result", fill=(16, 32, 51), font=_font(28, bold=True))
    result_lines = [
        "For the given statement, the system response is 'anger': 0.02,",
        "'disgust': 0.01, 'fear': 0.05, 'joy': 0.88 and 'sadness': 0.04.",
        "The dominant emotion is joy.",
    ]
    top = 850
    for line in result_lines:
        draw.text((395, top), line, fill=(47, 63, 80), font=_font(24))
        top += 34
